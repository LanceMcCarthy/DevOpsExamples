...
namespace MyAspNetCoreApp.Controllers
{
    ...
    {
        private readonly List<string> firstNames = new() { "Nancy", "Andrew", "Janet", "Margaret", "Steven", "Michael", "Robert", "Laura", "Anne", "Nige" };
        private readonly List<string> lastNames = new() { "Davolio", "Fuller", "Leverling", "Peacock", "Buchanan", "Suyama", "King", "Callahan", "Dodsworth", "White" };
        private readonly List<string> platforms = new() { "Apple Podcasts", "Spotify", "Other", "Overcast", "Anchor", "Stitcher" };
        private readonly List<string> devices = new() { "iOS", "Android", "Other", "Web" };

        public static Random Random = new();

        public static List<PodcastViewModel> Podcasts = new();
